...
const SEED_LABELS: SeedLabel[] = [
  ...
  // ===== DELHI =====
  { lat: 28.6315, lng: 77.2167, text: "Business hub of Delhi", safety: 3, vibe: ["Metro Access King", "High Traffic / Affordable"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 34, downvotes: 8 },
  { lat: 28.6330, lng: 77.2190, text: "Great for power shopping", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$$", color: "#ea580c", category: null, upvotes: 29, downvotes: 11 },
  { lat: 28.5494, lng: 77.2001, text: "Trendy cafes and boutiques", safety: 4, vibe: ["Old City Charm", "Women Safe"], cost: "$$", color: "#7c3aed", category: "Cafes to work", upvotes: 71, downvotes: 4 },
  { lat: 28.5510, lng: 77.1980, text: "Deer park nearby, peaceful", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Parks", upvotes: 52, downvotes: 3 },
  { lat: 28.5680, lng: 77.2410, text: "Affordable shopping market", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#ea580c", category: null, upvotes: 44, downvotes: 12 },
  { lat: 28.5700, lng: 77.2430, text: "Street food paradise Lajpat", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 88, downvotes: 4 },
  { lat: 28.6519, lng: 77.1909, text: "Dense market area Karol Bagh", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 33, downvotes: 15 },
  { lat: 28.6507, lng: 77.2311, text: "Old Delhi magic Chandni Chowk", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 97, downvotes: 7 },
  { lat: 28.6490, lng: 77.2330, text: "Spice market sensory overload", safety: 2, vibe: ["High Traffic / Affordable"], cost: "$", color: "#424242", category: null, upvotes: 24, downvotes: 19 },
  { lat: 28.5216, lng: 77.2099, text: "Mall central family destination", safety: 4, vibe: ["Metro Access King", "Family Zone"], cost: "$$$", color: "#64b5f6", category: null, upvotes: 38, downvotes: 9 },
  { lat: 28.5200, lng: 77.2080, text: "Great for families with kids", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Playgrounds", upvotes: 45, downvotes: 3 },
  { lat: 28.5697, lng: 77.2280, text: "Expat favourite area", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 56, downvotes: 6 },
  { lat: 28.5447, lng: 77.2440, text: "Luxury and calm in Delhi", safety: 4, vibe: ["Metro Access King", "Family Zone"], cost: "$$$$", color: "#4caf50", category: null, upvotes: 63, downvotes: 4 },
  { lat: 28.5691, lng: 77.2196, text: "Good restaurants row", safety: 4, vibe: ["Family Zone", "Metro Access King"], cost: "$$$", color: "#ea580c", category: "Restaurants", upvotes: 55, downvotes: 7 },
  { lat: 28.5225, lng: 77.1585, text: "Modern suburbs peaceful", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 34, downvotes: 5 },
  { lat: 28.5921, lng: 77.0460, text: "DDA flats large area", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 18, downvotes: 8 },
  { lat: 28.7279, lng: 77.1173, text: "Planned township feel", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 27, downvotes: 6 },
  { lat: 28.6952, lng: 77.1309, text: "Good schools and parks area", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Playgrounds", upvotes: 41, downvotes: 3 },
  { lat: 28.6441, lng: 77.2128, text: "Backpacker central Paharganj", safety: 3, vibe: ["High Traffic / Affordable"], cost: "$", color: "#424242", category: "Hotels", upvotes: 19, downvotes: 27 },
  { lat: 28.5896, lng: 77.2502, text: "Historic Sufi shrine Nizamuddin", safety: 3, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#7c3aed", category: null, upvotes: 63, downvotes: 4 },
  { lat: 28.5244, lng: 77.1855, text: "Qutub Minar ancient monuments", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#16a34a", category: null, upvotes: 76, downvotes: 3 },
  { lat: 28.6307, lng: 77.2845, text: "East Delhi hustle and bustle", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 22, downvotes: 11 },
  { lat: 28.6450, lng: 77.2964, text: "Metro connectivity excellent", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 35, downvotes: 7 },
  { lat: 28.5760, lng: 77.2290, text: "Best butter chicken here", safety: 4, vibe: ["Family Zone"], cost: "$$", color: "#ea580c", category: "Restaurants", upvotes: 88, downvotes: 2 },

  // ===== MUMBAI =====
  { lat: 19.0596, lng: 72.8295, text: "Bollywood beach vibes", safety: 4, vibe: ["High Traffic / Affordable", "Metro Access King"], cost: "$$$", color: "#db2777", category: "Bars", upvotes: 76, downvotes: 6 },
  { lat: 19.0610, lng: 72.8310, text: "Linking Road weekend shopping", safety: 4, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$$", color: "#ea580c", category: null, upvotes: 44, downvotes: 9 },
  { lat: 19.1002, lng: 72.8269, text: "Celebrities walking around Juhu", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 61, downvotes: 4 },
  { lat: 19.1000, lng: 72.8250, text: "Juhu beach sunsets magical", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#2563eb", category: "Parks", upvotes: 93, downvotes: 2 },
  { lat: 18.9067, lng: 72.9162, text: "Gateway of India morning walks", safety: 4, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$$", color: "#ea580c", category: null, upvotes: 85, downvotes: 3 },
  { lat: 18.9050, lng: 72.9140, text: "Luxury hotels row Colaba", safety: 5, vibe: ["Metro Access King"], cost: "$$$$", color: "#4caf50", category: "Hotels", upvotes: 47, downvotes: 5 },
  { lat: 19.1136, lng: 72.8697, text: "Malls and multiplex Andheri", safety: 4, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$$", color: "#9e9e9e", category: null, upvotes: 28, downvotes: 11 },
  { lat: 19.1150, lng: 72.8720, text: "Film studios nearby", safety: 4, vibe: ["Old City Charm"], cost: "$$", color: "#7c3aed", category: null, upvotes: 55, downvotes: 4 },
  { lat: 19.1197, lng: 72.9051, text: "IIT Bombay campus nearby", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#1565c0", category: "Coworking", upvotes: 67, downvotes: 3 },
  { lat: 19.1200, lng: 72.9070, text: "Tech park startup hub Powai", safety: 4, vibe: ["Metro Access King"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 72, downvotes: 5 },
  { lat: 18.9984, lng: 72.8310, text: "Upmarket restaurants Lower Parel", safety: 4, vibe: ["Metro Access King", "High Traffic / Affordable"], cost: "$$$", color: "#4caf50", category: "Restaurants", upvotes: 83, downvotes: 4 },
  { lat: 18.9990, lng: 72.8290, text: "Art deco heritage buildings", safety: 4, vibe: ["Old City Charm", "Metro Access King"], cost: "$$$", color: "#7c3aed", category: null, upvotes: 74, downvotes: 3 },
  { lat: 19.0095, lng: 72.8183, text: "Sea link bridge views", safety: 4, vibe: ["Women Safe", "Metro Access King"], cost: "$$$", color: "#2563eb", category: null, upvotes: 88, downvotes: 2 },
  { lat: 19.0178, lng: 72.8478, text: "Dadar local train junction", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 19, downvotes: 13 },
  { lat: 19.0706, lng: 72.8798, text: "Eastern suburb commuter area", safety: 3, vibe: ["High Traffic / Affordable"], cost: "$", color: "#424242", category: null, upvotes: 11, downvotes: 22 },
  { lat: 19.1874, lng: 72.8481, text: "Affordable flats Malad suburbs", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 23, downvotes: 8 },
  { lat: 19.0330, lng: 73.0297, text: "Navi Mumbai planned city", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 37, downvotes: 6 },
  { lat: 18.9432, lng: 72.8232, text: "Marine Drive joggers paradise", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$", color: "#16a34a", category: "Gyms", upvotes: 94, downvotes: 2 },
  { lat: 19.0620, lng: 72.8380, text: "SV Road best food joints", safety: 4, vibe: ["Family Zone"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 67, downvotes: 4 },
  ...
  // ===== MORE MUMBAI =====
  { lat: 19.0060, lng: 72.8190, text: "Bandra Fort sunset views", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#2563eb", category: "Parks", upvotes: 97, downvotes: 3 },
  { lat: 19.0528, lng: 72.8433, text: "Carter Road jogging promenade", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Gyms", upvotes: 82, downvotes: 2 },
  { lat: 18.9550, lng: 72.8138, text: "Nariman Point office district", safety: 4, vibe: ["Metro Access King", "High Traffic / Affordable"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 38, downvotes: 9 },
  { lat: 19.1730, lng: 72.9480, text: "Thane peaceful lakeside", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Parks", upvotes: 54, downvotes: 5 },

  // ===== MORE DELHI =====
  { lat: 28.6129, lng: 77.2295, text: "India Gate evening walks", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Parks", upvotes: 91, downvotes: 3 },
  { lat: 28.5538, lng: 77.2090, text: "Mehrauli Qutub archaeology", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#16a34a", category: null, upvotes: 67, downvotes: 4 },
  { lat: 28.6745, lng: 77.2180, text: "Civil Lines colonial bungalows", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 52, downvotes: 6 },
  { lat: 28.6290, lng: 77.0810, text: "Dwarka massive planned suburb", safety: 3, vibe: ["Family Zone"], cost: "$$", color: "#9e9e9e", category: null, upvotes: 29, downvotes: 9 },
  { lat: 28.4595, lng: 77.0266, text: "Gurugram cyber city growth", safety: 4, vibe: ["Metro Access King"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 43, downvotes: 14 },
  ...
  // ===== MUMBAI EXTRA =====
  { lat: 19.0060, lng: 72.8420, text: "Bandra West brunch capital", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: "Cafes to work", upvotes: 88, downvotes: 4 },
  { lat: 19.1310, lng: 72.9100, text: "Hiranandani Powai pretty lake", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Parks", upvotes: 72, downvotes: 3 },
  { lat: 18.9920, lng: 72.8317, text: "Worli Sea Face sunset walk", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$", color: "#2563eb", category: "Parks", upvotes: 85, downvotes: 2 },

  // ===== DELHI EXTRA =====
  { lat: 28.5335, lng: 77.2090, text: "Green Park markets great lunch", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Restaurants", upvotes: 52, downvotes: 6 },
  { lat: 28.5000, lng: 77.1545, text: "Vasant Kunj malls everywhere", safety: 4, vibe: ["Family Zone", "Metro Access King"], cost: "$$$", color: "#4caf50", category: null, upvotes: 38, downvotes: 11 },
  { lat: 28.6200, lng: 77.3100, text: "Noida extension affordable flats", safety: 3, vibe: ["Family Zone"], cost: "$$", color: "#9e9e9e", category: null, upvotes: 27, downvotes: 8 },
  ...
  // ===== KARACHI =====
  { lat: 24.8120, lng: 67.0313, text: "Clifton sea breezes upscale feel", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 67, downvotes: 9 },
  { lat: 24.8218, lng: 67.0367, text: "Zamzama dining street restaurant row", safety: 4, vibe: ["Metro Access King", "Family Zone"], cost: "$$$", color: "#ea580c", category: "Restaurants", upvotes: 83, downvotes: 5 },
  { lat: 24.8037, lng: 67.0540, text: "DHA Defence gated community calm", safety: 5, vibe: ["Family Zone", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 71, downvotes: 7 },
  { lat: 24.8556, lng: 67.0127, text: "Saddar colonial era commerce hub", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$$", color: "#9e9e9e", category: null, upvotes: 38, downvotes: 19 },
  { lat: 24.9337, lng: 67.1057, text: "Gulshan-e-Iqbal middle class heart", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 44, downvotes: 13 },
  { lat: 24.8745, lng: 67.0548, text: "PECHS quiet residential streets", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 52, downvotes: 6 },
  { lat: 24.9050, lng: 67.0850, text: "North Nazimabad affordable living", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 31, downvotes: 11 },

  // ===== LAHORE =====
  { lat: 31.5218, lng: 74.3462, text: "Gulberg upscale Lahore lifestyle", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: "Restaurants", upvotes: 76, downvotes: 6 },
  { lat: 31.5099, lng: 74.3437, text: "Liberty Market fashion and food", safety: 4, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$$", color: "#ea580c", category: null, upvotes: 64, downvotes: 9 },
  { lat: 31.5804, lng: 74.3214, text: "Walled City Mughal heritage alive", safety: 3, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#7c3aed", category: null, upvotes: 92, downvotes: 8 },
  { lat: 31.5820, lng: 74.3240, text: "Lahore Fort and Badshahi Mosque", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 107, downvotes: 4 },
  { lat: 31.4825, lng: 74.3971, text: "DHA Lahore modern gated living", safety: 5, vibe: ["Family Zone", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 63, downvotes: 7 },
  { lat: 31.4949, lng: 74.3120, text: "Model Town colonial garden city", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Parks", upvotes: 55, downvotes: 5 },
  { lat: 31.4697, lng: 74.2681, text: "Johar Town dense and affordable", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#9e9e9e", category: null, upvotes: 41, downvotes: 12 },
  { lat: 31.5507, lng: 74.3436, text: "Mall Road colonial promenade", safety: 4, vibe: ["Family Zone", "Old City Charm"], cost: "$$", color: "#16a34a", category: null, upvotes: 69, downvotes: 5 },

  // ===== BANGALORE =====
  { lat: 12.9352, lng: 77.6245, text: "Koramangala startup culture everywhere", safety: 4, vibe: ["Metro Access King", "Old City Charm"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 94, downvotes: 5 },
  { lat: 12.9716, lng: 77.6412, text: "Indiranagar 100 Feet Road pub crawl", safety: 4, vibe: ["High Traffic / Affordable", "Metro Access King"], cost: "$$$", color: "#7c3aed", category: "Bars", upvotes: 87, downvotes: 6 },
  { lat: 12.9758, lng: 77.6012, text: "Cubbon Park morning jogs peaceful", safety: 5, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Parks", upvotes: 103, downvotes: 2 },
  { lat: 12.9698, lng: 77.5985, text: "MG Road malls and cafes buzzing", safety: 4, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$$", color: "#ea580c", category: null, upvotes: 61, downvotes: 9 },
  { lat: 12.8445, lng: 77.6791, text: "Electronic City IT campus ghost town on weekends", safety: 4, vibe: ["Women Safe"], cost: "$$", color: "#9e9e9e", category: "Coworking", upvotes: 33, downvotes: 18 },
  { lat: 12.9279, lng: 77.6271, text: "HSR Layout best biryani in Bangalore", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#ea580c", category: "Restaurants", upvotes: 82, downvotes: 3 },
  { lat: 13.0071, lng: 77.5686, text: "Malleswaram old Bangalore charm", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 69, downvotes: 4 },
  { lat: 12.9165, lng: 77.6101, text: "Jayanagar South Bangalore quiet and green", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: "Parks", upvotes: 74, downvotes: 3 },
  { lat: 12.9698, lng: 77.7499, text: "Whitefield tech park sprawl long commute", safety: 3, vibe: ["Women Safe"], cost: "$$", color: "#9e9e9e", category: "Coworking", upvotes: 29, downvotes: 22 },
  { lat: 12.9141, lng: 77.6411, text: "BTM Layout affordable student area", safety: 3, vibe: ["Women Safe", "Family Zone"], cost: "$", color: "#0d9488", category: null, upvotes: 55, downvotes: 7 },
  { lat: 12.9352, lng: 77.6122, text: "Lalbagh Botanical Garden stunning roses", safety: 5, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Parks", upvotes: 91, downvotes: 1 },
  { lat: 13.0453, lng: 77.6269, text: "Hebbal lake views excellent", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#2563eb", category: "Parks", upvotes: 63, downvotes: 4 },

  // ===== HYDERABAD =====
  { lat: 17.4123, lng: 78.4485, text: "Banjara Hills upscale restaurants row", safety: 4, vibe: ["Metro Access King", "Family Zone"], cost: "$$$", color: "#4caf50", category: "Restaurants", upvotes: 88, downvotes: 5 },
  { lat: 17.4316, lng: 78.4065, text: "Jubilee Hills celebrity neighbourhood", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$$", color: "#4caf50", category: null, upvotes: 71, downvotes: 6 },
  { lat: 17.4474, lng: 78.3762, text: "Hitech City CYBERABAD IT hub", safety: 4, vibe: ["Metro Access King"], cost: "$$$", color: "#64b5f6", category: "Coworking", upvotes: 79, downvotes: 7 },
  { lat: 17.4400, lng: 78.3489, text: "Gachibowli stadium area modern flats", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 58, downvotes: 6 },
  { lat: 17.3616, lng: 78.4747, text: "Charminar Hyderabadi biryani origin", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 127, downvotes: 3 },
  { lat: 17.4399, lng: 78.4983, text: "Secunderabad twin city calm pace", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 47, downvotes: 5 },
  { lat: 17.4239, lng: 78.4738, text: "Begumpet good for expats and families", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 52, downvotes: 4 },
  { lat: 17.3850, lng: 78.4867, text: "Old City walled bazaars and mosques", safety: 3, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#7c3aed", category: null, upvotes: 83, downvotes: 7 },
  { lat: 17.4948, lng: 78.3996, text: "Madhapur cafes and tech bro coffee", safety: 4, vibe: ["Women Safe", "Old City Charm"], cost: "$$", color: "#0d9488", category: "Cafes to work", upvotes: 66, downvotes: 5 },
  { lat: 17.3614, lng: 78.3998, text: "Golconda Fort ancient wonder nearby", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 95, downvotes: 2 },

  // ===== PUNE =====
  { lat: 18.5362, lng: 73.8929, text: "Koregaon Park brunch scene incredible", safety: 4, vibe: ["Metro Access King", "Old City Charm"], cost: "$$$", color: "#7c3aed", category: "Restaurants", upvotes: 91, downvotes: 4 },
  { lat: 18.5524, lng: 73.9012, text: "Kalyani Nagar young professionals area", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$", color: "#0d9488", category: "Coworking", upvotes: 73, downvotes: 5 },
  { lat: 18.5679, lng: 73.9143, text: "Viman Nagar airport proximity good", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 54, downvotes: 6 },
  { lat: 18.4907, lng: 73.8140, text: "Kothrud residential and very affordable", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 49, downvotes: 5 },
  { lat: 18.5195, lng: 73.8553, text: "Camp area colonial charm Pune", safety: 4, vibe: ["Family Zone", "Old City Charm"], cost: "$$", color: "#7c3aed", category: null, upvotes: 67, downvotes: 5 },
  { lat: 18.5966, lng: 73.7340, text: "Hinjewadi tech park Pune's Electronic City", safety: 3, vibe: ["Women Safe"], cost: "$$", color: "#9e9e9e", category: "Coworking", upvotes: 34, downvotes: 19 },
  { lat: 18.5116, lng: 73.9283, text: "Magarpatta self-contained smart city", safety: 5, vibe: ["Family Zone", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 61, downvotes: 4 },
  { lat: 18.5236, lng: 73.8478, text: "Shivaji Nagar heart of Pune city", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 38, downvotes: 11 },
  { lat: 18.6186, lng: 73.8037, text: "Aundh peaceful suburb great malls", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 58, downvotes: 4 },
  { lat: 18.5271, lng: 73.8778, text: "FC Road student hangout zone", safety: 4, vibe: ["Women Safe", "High Traffic / Affordable"], cost: "$", color: "#0d9488", category: "Cafes to work", upvotes: 77, downvotes: 5 },

  // ===== CHENNAI =====
  { lat: 13.0418, lng: 80.2341, text: "T Nagar shopping mecca for sarees", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#ea580c", category: null, upvotes: 88, downvotes: 7 },
  { lat: 13.0827, lng: 80.2707, text: "Anna Nagar planned suburb very liveable", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 73, downvotes: 4 },
  { lat: 13.0012, lng: 80.2565, text: "Adyar quiet and green expat favourite", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 81, downvotes: 3 },
  { lat: 13.0002, lng: 80.2707, text: "Besant Nagar beach walks evening bliss", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#2563eb", category: "Parks", upvotes: 97, downvotes: 2 },
  { lat: 13.0569, lng: 80.2466, text: "Nungambakkam upscale dining and embassies", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: "Restaurants", upvotes: 64, downvotes: 5 },
  { lat: 12.8996, lng: 80.2209, text: "OMR IT corridor long drive but good pay", safety: 4, vibe: ["Women Safe"], cost: "$$", color: "#9e9e9e", category: "Coworking", upvotes: 45, downvotes: 13 },
  { lat: 13.0337, lng: 80.2697, text: "Mylapore ancient temple neighbourhood", safety: 4, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#7c3aed", category: null, upvotes: 89, downvotes: 3 },
  { lat: 13.0770, lng: 80.2604, text: "Egmore budget hotels near railway", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: "Hotels", upvotes: 29, downvotes: 16 },
  { lat: 12.9591, lng: 80.2175, text: "Velachery south Chennai well connected", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 55, downvotes: 5 },
  { lat: 13.1018, lng: 80.2122, text: "Ambattur industrial area affordable flats", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 31, downvotes: 9 },

  // ===== KOLKATA =====
  { lat: 22.5526, lng: 88.3529, text: "Park Street Kolkata's nightlife heart", safety: 4, vibe: ["High Traffic / Affordable", "Metro Access King"], cost: "$$$", color: "#7c3aed", category: "Bars", upvotes: 86, downvotes: 5 },
  { lat: 22.5732, lng: 88.4324, text: "Salt Lake City Sector V IT hub modern", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#64b5f6", category: "Coworking", upvotes: 61, downvotes: 6 },
  { lat: 22.5152, lng: 88.3690, text: "Ballygunge educated affluent area", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 67, downvotes: 4 },
  { lat: 22.5896, lng: 88.4735, text: "New Town Rajarhat tech and new apartments", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 53, downvotes: 6 },
  { lat: 22.5851, lng: 88.3468, text: "North Kolkata heritage homes and chaos", safety: 3, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#7c3aed", category: null, upvotes: 74, downvotes: 8 },
  { lat: 22.5726, lng: 88.3639, text: "College Street bookstores everywhere", safety: 4, vibe: ["Old City Charm", "Women Safe"], cost: "$", color: "#7c3aed", category: "Bookstores", upvotes: 98, downvotes: 2 },
  { lat: 22.5448, lng: 88.3298, text: "Maidan huge green lung of Kolkata", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: "Parks", upvotes: 81, downvotes: 3 },
  { lat: 22.5869, lng: 88.3278, text: "Howrah Bridge iconic walk early morning", safety: 3, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#2563eb", category: null, upvotes: 107, downvotes: 3 },
  { lat: 22.5243, lng: 88.3618, text: "Kalighat temple morning pilgrimage", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#ea580c", category: null, upvotes: 66, downvotes: 5 },
  { lat: 22.5646, lng: 88.3444, text: "New Market best street food Kolkata", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 93, downvotes: 4 },

  // ===== JAIPUR =====
  { lat: 26.9260, lng: 75.8235, text: "Pink City old walled city breathtaking", safety: 3, vibe: ["Family Zone", "Old City Charm"], cost: "$", color: "#db2777", category: null, upvotes: 112, downvotes: 5 },
  { lat: 26.8927, lng: 75.8069, text: "Malviya Nagar best restaurants in Jaipur", safety: 4, vibe: ["Family Zone", "Metro Access King"], cost: "$$", color: "#ea580c", category: "Restaurants", upvotes: 79, downvotes: 4 },
  { lat: 26.9124, lng: 75.7390, text: "Vaishali Nagar western Jaipur modern living", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 58, downvotes: 5 },
  { lat: 26.9000, lng: 75.8235, text: "C-scheme upscale consulates area", safety: 4, vibe: ["Metro Access King", "Women Safe"], cost: "$$$", color: "#4caf50", category: null, upvotes: 62, downvotes: 4 },
  { lat: 26.9197, lng: 75.8032, text: "Bani Park quiet heritage haveli area", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#16a34a", category: null, upvotes: 54, downvotes: 3 },
  { lat: 26.9124, lng: 75.7877, text: "Mansarovar huge planned township", safety: 3, vibe: ["Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 38, downvotes: 8 },
  { lat: 26.9197, lng: 75.8255, text: "MI Road main drag shopping and chaos", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#ea580c", category: null, upvotes: 44, downvotes: 12 },
  { lat: 26.9855, lng: 75.8513, text: "Amber Fort area tourist town excellent", safety: 4, vibe: ["Family Zone", "Old City Charm"], cost: "$$", color: "#7c3aed", category: null, upvotes: 103, downvotes: 3 },
  { lat: 26.9315, lng: 75.8467, text: "Raja Park local Jaipur feel authentic", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 49, downvotes: 5 },
  { lat: 26.9260, lng: 75.8195, text: "Johari Bazaar gems and jewellery street", safety: 3, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$$", color: "#db2777", category: null, upvotes: 84, downvotes: 6 },
  ...
  { lat: 26.8785, lng: 80.9985, text: "Indiranagar best restaurants in Lucknow", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$$", color: "#ea580c", category: "Restaurants", upvotes: 74, downvotes: 5 },
  { lat: 26.8268, lng: 80.9573, text: "Ashiyana Colony affordable family suburb", safety: 4, vibe: ["Family Zone", "High Traffic / Affordable"], cost: "$", color: "#16a34a", category: null, upvotes: 53, downvotes: 4 },
  { lat: 26.8875, lng: 80.9756, text: "Aliganj educated middle class area", safety: 4, vibe: ["Family Zone", "Student Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 61, downvotes: 3 },
  ...
  { lat: 26.8430, lng: 80.8973, text: "Vikas Nagar DDA housing affordable", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 34, downvotes: 8 },
  ...
  { lat: 26.8654, lng: 80.9523, text: "Mahanagar peaceful tree-lined avenues", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 58, downvotes: 3 },
  ...
  { lat: 22.7426, lng: 75.8775, text: "Mahalakshmi Nagar family residential area", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 62, downvotes: 4 },
  ...
  { lat: 22.7286, lng: 75.8649, text: "Annapurna Colony temple town vibe calm", safety: 4, vibe: ["Family Zone", "Women Safe"], cost: "$", color: "#16a34a", category: null, upvotes: 54, downvotes: 3 },
  { lat: 22.6995, lng: 75.8333, text: "Sudama Nagar working class affordable", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 37, downvotes: 8 },
  ...
  { lat: 22.7154, lng: 75.9272, text: "Lasudia affordable eastern suburb", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 31, downvotes: 7 },
  ...
  { lat: 22.7286, lng: 75.8793, text: "Treasure Island Mall area Indore nightlife", safety: 4, vibe: ["Metro Access King", "High Traffic / Affordable"], cost: "$$", color: "#7c3aed", category: "Bars", upvotes: 55, downvotes: 7 },
  { lat: 22.7534, lng: 75.8694, text: "Bicholi Mardana peaceful greens suburb", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 43, downvotes: 5 },
  ...
  { lat: 11.0228, lng: 76.9559, text: "Saibaba Colony clean tree-lined streets", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$$", color: "#16a34a", category: null, upvotes: 73, downvotes: 3 },
  { lat: 11.0495, lng: 76.9782, text: "Singanallur manufacturing and mid-range housing", safety: 3, vibe: ["High Traffic / Affordable", "Family Zone"], cost: "$", color: "#9e9e9e", category: null, upvotes: 38, downvotes: 7 },
  ...
  { lat: 11.0145, lng: 76.9226, text: "Vadavalli peaceful western suburb", safety: 4, vibe: ["Women Safe", "Family Zone"], cost: "$", color: "#16a34a", category: null, upvotes: 62, downvotes: 4 },
  ...
  { lat: 10.9957, lng: 76.9730, text: "Ramanathapuram north Coimbatore upcoming area", safety: 4, vibe: ["Upcoming Area", "Family Zone"], cost: "$$", color: "#0d9488", category: null, upvotes: 46, downvotes: 5 },
  { lat: 11.0100, lng: 77.0062, text: "Ukkadam traditional market old Coimbatore", safety: 3, vibe: ["Old City Charm", "Family Zone"], cost: "$", color: "#ea580c", category: "Restaurants", upvotes: 61, downvotes: 8 },
];
